...
CREATE USER 'slimane'@'%' IDENTIFIED BY 'slimane';
CREATE USER 'ro_slimane'@'%' IDENTIFIED BY 'ro_slimane';
GRANT ALL PRIVILEGES ON wordpress.* TO 'slimane'@'%';
GRANT SELECT ON wordpress.* TO 'ro_slimane'@'%';
...
INSERT INTO `wp_comments` VALUES (1,1,'A WordPress Commenter','wapuu@wordpress.example','https://wordpress.org/','','2022-04-08 03:17:45','2022-04-08 03:17:45','Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.',0,'1','','comment',0,0);
...
INSERT INTO `wp_usermeta` VALUES (1,1,'nickname','slimane'),(2,1,'first_name',''),(3,1,'last_name',''),(4,1,'description',''),(5,1,'rich_editing','true'),(6,1,'syntax_highlighting','true'),(7,1,'comment_shortcuts','false'),(8,1,'admin_color','fresh'),(9,1,'use_ssl','0'),(10,1,'show_admin_bar_front','true'),(11,1,'locale',''),(12,1,'wp_capabilities','a:1:{s:13:\"administrator\";b:1;}'),(13,1,'wp_user_level','10'),(14,1,'dismissed_wp_pointers',''),(15,1,'show_welcome_panel','1');
...
INSERT INTO `wp_users` VALUES (1,'slimane','$P$BjREv4o8lrqczhEXlYU6kw0VF3RWgP/','slimane','sliman.chan@gmail.com','http://localhost','2022-04-08 03:17:45','',0,'slimane');
...
-- Dump completed on 2022-04-08  3:19:48
